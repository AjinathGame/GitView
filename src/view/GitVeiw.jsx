...
const GitVeiw = () => {
    ...
    if (notfound) {
        return (
            <div className='flex flex-col justify-center items-center h-screen w-screen bg-black/90'>
                <h1 className='text-5xl font-bold text-red-600'>User Not Found</h1>
                <button onClick={() => {setnotfound(false);}} className="mt-8 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 cursor-pointer rounded-full text-2xl transition-colors"> Go Back</button>
            </div>
        );
    }
